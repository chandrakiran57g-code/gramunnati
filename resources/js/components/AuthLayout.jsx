...
export default function AuthLayout({ icon: Icon, title, subtitle, footer, children, showPublicChrome = false }) {
  const card = (
  ...
  if (showPublicChrome) {
    return (
      <div className="min-h-screen flex flex-col">
        <Navbar />
        <main className="flex-1 pt-16 flex items-center justify-center bg-background px-4 py-16">
          {card}
        </main>
        <Footer />
      </div>
