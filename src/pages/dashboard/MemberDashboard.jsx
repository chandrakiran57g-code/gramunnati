...
const BADGES = [
  ...
  { id: 'village_supporter', label: 'Village Supporter', icon: '🏘️', color: 'bg-primary/10 text-primary' },
];
...
export default function MemberDashboard() {
  ...
  if (!user) return (
    <div className="min-h-screen flex items-center justify-center text-center px-4">
      <div>
        ...
        <Link to="/login"><Button className="brand-gradient text-white border-0">Login</Button></Link>
      </div>
    </div>
  );
  ...
  const widgets = [
    ...
    { label: 'Donations Made', value: successDonations.length, icon: TrendingUp, color: 'text-primary', bg: 'bg-primary/10' },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <HeroScrollSection size="page">
        <div className="brand-gradient py-12 px-4">
        ...
        <Tabs defaultValue="donations" className="w-full">
          ...
          <TabsContent value="villages">
            <div className="bg-white rounded-2xl border border-border p-8 text-center">
              ...
              <Link to="/my-villages"><Button variant="outline" className="border-primary text-primary">View My Villages</Button></Link>
            </div>
          </TabsContent>
