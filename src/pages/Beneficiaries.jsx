              ...
              {filtered.map((b, i) => (
                ...
                >
                  <Link to={`/beneficiaries/${b.slug}`}
                    className="block group bg-white rounded-2xl border border-border overflow-hidden hover:shadow-lg hover:border-village/30 transition-all duration-300 h-full"
                  >
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="font-semibold text-foreground group-hover:text-village transition-colors mb-1">{b.name}</h3>
                      ...
                      <span className="inline-flex items-center gap-1 text-village text-sm font-medium mt-3 group-hover:gap-2 transition-all">
