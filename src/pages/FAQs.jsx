...
const faqs = [
  { q: 'What is CMSR?', a: 'CMSR is a nationwide digital platform connecting villagers, students, donors, volunteers, and organizations to participate in village and school development across India. Our vision is "Our Village – Our Responsibility – Our Development."' },
  ...
  { q: 'Is my donation tax deductible?', a: 'CMSR is working towards 80G certification. Currently, donations may not be tax-deductible. We will notify all donors once certification is obtained.' },
  ...
  { q: 'How is the donated money used?', a: 'Donations are used directly for the specified purpose (village, school, or project). CMSR maintains transparency by publishing fund utilization reports on each village and project page.' },
  ...
  { q: 'How do I register my village?', a: 'Contact us through the Contact page or email us at contact@CMSR.in. Our team will guide you through the village registration process and appoint a representative.' },
