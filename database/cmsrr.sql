-- CMSRR MySQL schema + seed (generated 2026-07-03 16:48:11)
...
(1, 'Admin', 'test@gmail.com', NULL, '$2y$12$ixlYNbepbx5IaB9dcHCr6OR1lxFTjT/wfBWruCRYxWCB4LMW.WdAG', NULL, '2026-07-03 16:48:10', '2026-07-03 16:48:10');
...
(1, 1, NULL, NULL, 'Admin', 'test@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-07-03 16:48:10', '2026-07-03 16:48:10');

INSERT INTO `roles` (`id`, `name`, `guard_name`, `description`, `created_at`, `updated_at`) VALUES
(1, 'Super Admin', 'web', 'Full access', '2026-07-03 16:48:09', '2026-07-03 16:48:09'),
(2, 'Member', 'web', 'Default member', '2026-07-03 16:48:09', '2026-07-03 16:48:09');

INSERT INTO `user_roles` (`user_id`, `role_id`) VALUES
(1, 1);

INSERT INTO `user_categories` (`id`, `name`, `slug`, `created_at`, `updated_at`) VALUES
(1, 'Citizen', 'citizen', '2026-07-03 16:48:09', '2026-07-03 16:48:09');
...
(1, 'Telangana', 'TS', 1, '2026-07-03 16:48:10', '2026-07-03 16:48:10');

INSERT INTO `districts` (`id`, `state_id`, `name`, `code`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 1, 'Hyderabad', 'HYD', 1, '2026-07-03 16:48:10', '2026-07-03 16:48:10');

INSERT INTO `mandals` (`id`, `district_id`, `name`, `code`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 1, 'Ameerpet', 'AMP', 1, '2026-07-03 16:48:10', '2026-07-03 16:48:10');

INSERT INTO `settings` (`id`, `key`, `value`, `created_at`, `updated_at`) VALUES
(1, 'site_name', 'CMSR', '2026-07-03 16:48:10', '2026-07-03 16:48:10'),
(2, 'site_tagline', 'Common Man Social Responsibility', '2026-07-03 16:48:10', '2026-07-03 16:48:10'),
(3, 'contact_email', 'contact@cmsr.in', '2026-07-03 16:48:11', '2026-07-03 16:48:11'),
(4, 'contact_phone', '+91 98765 43210', '2026-07-03 16:48:11', '2026-07-03 16:48:11'),
(5, 'contact_address', 'Hyderabad, Telangana, India', '2026-07-03 16:48:11', '2026-07-03 16:48:11'),
(6, 'donation_enabled', 'true', '2026-07-03 16:48:11', '2026-07-03 16:48:11'),
(7, 'nav_config', '{"items":[{"key":"about-us","label":"About Us","type":"dropdown","enabled":true,"order":0,"source":"cms","navGroup":"about_us"},{"key":"teams","label":"Teams","type":"dropdown","enabled":true,"order":1,"source":"team_groups"},{"key":"what-we-do","label":"What We Do","type":"dropdown","enabled":true,"order":2,"source":"programs"},{"key":"member-list","label":"Member List","type":"link","enabled":true,"order":3,"path":"\\/members"},{"key":"partners","label":"Partner Organizations","type":"link","enabled":true,"order":4,"path":"\\/partners"},{"key":"gallery","label":"Gallery","type":"link","enabled":true,"order":5,"path":"\\/gallery"},{"key":"contact","label":"Contact Us","type":"link","enabled":true,"order":6,"path":"\\/contact"}]}', '2026-07-03 16:48:11', '2026-07-03 16:48:11'),
(8, 'cms_nav_groups', '{"1":"about_us","2":"about_us","3":"about_us","4":"about_us","5":"about_us","6":"about_us","7":"about_us"}', '2026-07-03 16:48:11', '2026-07-03 16:48:11');
...
(1, 'About CMSR', 'about-cmsr', 'About our mission to empower villages and schools across India.', 'As responsible citizens, we all have a social responsibility towards our communities. Through CMSR, citizens voluntarily come together to support village development and school empowerment across India.', NULL, NULL, NULL, 'active', 1, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL, NULL, NULL),
(2, 'Our Vision', 'our-vision', 'Our Village – Our Responsibility – Our Development', 'By uniting citizens, communities, and institutions on a common platform, we create sustainable, self-reliant model villages and schools.', NULL, NULL, NULL, 'active', 2, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'Our Mission', 'our-mission', 'Connecting people to build better villages and schools.', 'Our mission is to create a nationwide digital platform that connects villagers, donors, volunteers, and organizations.', NULL, NULL, NULL, 'active', 3, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'About Villages', 'about-villages', 'Understanding the village development program.', 'The village module allows communities to create digital profiles, track development needs, and receive donations.', NULL, NULL, NULL, 'active', 4, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL, NULL, NULL),
(5, 'About Schools', 'about-schools', 'How we empower rural schools.', 'Our school empowerment program focuses on infrastructure, digital classrooms, and connecting schools with donors.', NULL, NULL, NULL, 'active', 5, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL, NULL, NULL),
(6, 'About Volunteers', 'about-volunteers', 'Join our volunteer network.', 'Volunteers are the backbone of CMSR. Register on the Volunteer page to be matched with relevant projects.', NULL, NULL, NULL, 'active', 6, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL, NULL, NULL),
(7, 'About Donations', 'about-donations', 'How your donations make an impact.', 'Every donation is tracked transparently. Donate to a village, school, or project and see your impact.', NULL, NULL, NULL, 'active', 7, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL, NULL, NULL);

INSERT INTO `faqs` (`id`, `question`, `answer`, `sort_order`, `is_active`, `created_at`, `updated_at`, `question_te`, `answer_te`) VALUES
(1, 'What is CMSR?', 'CMSR (Common Man Social Responsibility) is a nationwide platform connecting citizens to village and school development.', 1, 1, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL),
(2, 'How do I become a volunteer?', 'Visit the Volunteer page, fill in the registration form with your skills and availability. Our team will review and contact you.', 4, 1, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL);
...
(1, 1, 1, 1, 'Kondapur', NULL, 'kondapur', NULL, NULL, NULL, 'Digital classroom and water supply.', NULL, NULL, 0, 0, 0, 0, 0, NULL, 0, NULL, NULL, 0, 0, NULL, 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 1, 1, 1, 'Rajapet', NULL, 'rajapet', NULL, NULL, NULL, 'Women SHG and tree plantation.', NULL, NULL, 0, 0, 0, 0, 0, NULL, 0, NULL, NULL, 0, 0, NULL, 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=800&q=80', NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, 1, 'ZPHS Kondapur', 'zphs-kondapur', 'government', NULL, NULL, NULL, NULL, NULL, 320, 12, 0, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 'https://images.unsplash.com/photo-1580582932707-520aed937b7b?w=800&q=80', 1, 1, NULL, NULL, NULL, NULL, NULL, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL);

INSERT INTO `project_categories` (`id`, `name`, `slug`, `icon`, `description`, `created_at`, `updated_at`, `name_te`, `description_te`) VALUES
(1, 'Water Conservation', 'water-conservation', '💧', NULL, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL);
...
(1, 1, 1, NULL, 'Water Harvest — Kondapur', 'water-harvest-kondapur', 'Rainwater harvesting for farming families.', NULL, NULL, 250000, 180000, 0, NULL, NULL, 'active', 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=800&q=80', NULL, NULL, NULL, NULL, NULL, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, 'Village Development', 'village-development', 'Comprehensive rural development initiatives focusing on infrastructure, governance, and community empowerment.', '🏘️', NULL, NULL, NULL, NULL, 'active', 1, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL),
(2, 'School Empowerment', 'school-empowerment', 'Transforming rural schools through digital classrooms, infrastructure upgrades, and teacher training.', '🏫', NULL, NULL, NULL, NULL, 'active', 2, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL),
(3, 'Tree Plantation', 'tree-plantation', 'Large-scale afforestation drives planting native species and fruit orchards across villages.', '🌳', NULL, NULL, NULL, NULL, 'active', 3, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL),
(4, 'Water Conservation', 'water-conservation', 'Building check dams, rainwater harvesting systems, and rejuvenating traditional water bodies.', '💧', NULL, NULL, NULL, NULL, 'active', 4, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL),
(5, 'Agriculture Development', 'agriculture-development', 'Supporting farmers with modern techniques, organic farming, and market linkages.', '🌾', NULL, NULL, NULL, NULL, 'active', 5, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL),
(6, 'Women SHGs', 'women-shgs', 'Empowering rural women through Self-Help Groups and entrepreneurship programs.', '👩', NULL, NULL, NULL, NULL, 'active', 6, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL),
(7, 'Skill Development', 'skill-development', 'Youth-focused skill training in IT, trades, and entrepreneurship.', '🎓', NULL, NULL, NULL, NULL, 'active', 7, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL),
(8, 'Healthcare', 'healthcare', 'Improving rural healthcare through medical camps and health awareness drives.', '🏥', NULL, NULL, NULL, NULL, 'active', 8, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL, NULL, NULL);
...
(1, 'Core Team', 'core-team', 'The founding and leadership team driving CMSR forward.', 'active', 1, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL),
(2, 'Advisory Board', 'advisory-board', 'Distinguished experts guiding our strategy and governance.', 'active', 2, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL),
(3, 'Technical Team', 'technical-team', 'Engineers and developers building the platform.', 'active', 3, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL),
(4, 'Village Coordinators', 'village-coordinators', 'Field coordinators working directly with villages.', 'active', 4, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL),
(5, 'School Coordinators', 'school-coordinators', 'Coordinators managing school empowerment programs.', 'active', 5, '2026-07-03 16:48:10', '2026-07-03 16:48:10', NULL, NULL);
