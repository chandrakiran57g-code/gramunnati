...
class CmsrSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $cmsPages = [
            ['slug' => 'about-cmsr', 'title' => 'About CMSR', 'short_description' => 'About our mission to empower villages and schools across India.', 'content' => 'As responsible citizens, we all have a social responsibility towards our communities. Through CMSR, citizens voluntarily come together to support village development and school empowerment across India.', 'display_order' => 1],
            ['slug' => 'our-vision', 'title' => 'Our Vision', 'short_description' => 'Our Village – Our Responsibility – Our Development', 'content' => 'By uniting citizens, communities, and institutions on a common platform, we create sustainable, self-reliant model villages and schools.', 'display_order' => 2],
            ['slug' => 'our-mission', 'title' => 'Our Mission', 'short_description' => 'Connecting people to build better villages and schools.', 'content' => 'Our mission is to create a nationwide digital platform that connects villagers, donors, volunteers, and organizations.', 'display_order' => 3],
            ['slug' => 'about-villages', 'title' => 'About Villages', 'short_description' => 'Understanding the village development program.', 'content' => 'The village module allows communities to create digital profiles, track development needs, and receive donations.', 'display_order' => 4],
            ['slug' => 'about-schools', 'title' => 'About Schools', 'short_description' => 'How we empower rural schools.', 'content' => 'Our school empowerment program focuses on infrastructure, digital classrooms, and connecting schools with donors.', 'display_order' => 5],
            ['slug' => 'about-volunteers', 'title' => 'About Volunteers', 'short_description' => 'Join our volunteer network.', 'content' => 'Volunteers are the backbone of CMSR. Register on the Volunteer page to be matched with relevant projects.', 'display_order' => 6],
            ['slug' => 'about-donations', 'title' => 'About Donations', 'short_description' => 'How your donations make an impact.', 'content' => 'Every donation is tracked transparently. Donate to a village, school, or project and see your impact.', 'display_order' => 7],
        ];
